...
CREATE TABLE  Country  (
   ...
   Continent varchar(15) NOT NULL CHECK (Continent IN('Asia','Europe','North America','Africa','Oceania','Antarctica','South America')),
...
CREATE TABLE  CountryLanguage  (
   ...
   IsOfficial varchar(15) CHECK (IsOfficial IN ('T','F')),
